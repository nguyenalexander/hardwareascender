var HardwareAscender = angular.module('HardwareAscender', ['ngRoute','ngResource', 'ngMaterial', 'ngMessages', 'ui.router', 'angular-cloudinary', 'angularFileUpload', 'angular-loading-bar', 'ngFx', 'ngAnimate']);
...
HardwareAscender.run(['$rootScope', 'UserService', '$timeout', 'cfpLoadingBar', function($rootScope, UserService, $timeout, cfpLoadingBar) {
